...
import com.jpb.eleven.adapters.AlbumArtPagerAdapter;
import com.jpb.eleven.cache.ImageFetcher;
import com.jpb.eleven.loaders.NowPlayingCursor;
import com.jpb.eleven.loaders.QueueLoader;
import com.jpb.eleven.menu.CreateNewPlaylist;
import com.jpb.eleven.menu.DeleteDialog;
import com.jpb.eleven.ui.activities.HomeActivity;
...
import com.jpb.eleven.widgets.MainPlaybackControls;
import com.jpb.eleven.widgets.NoResultsContainer;
import com.jpb.eleven.widgets.VisualizerView;
...
public class AudioPlayerFragment extends Fragment implements ServiceConnection {
    ...
    private void initHeaderBar() {
        ...
        mSongTitle.findViewById(R.id.header_bar_song_title).setSelected(true);
        mArtistName.findViewById(R.id.header_bar_artist_title).setSelected(true);
    }
